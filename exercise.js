...
function getNextCommitteeMember() {
    commIndex++;
    if (commIndex === project.committee.length) {
        commIndex = 0;
    }

    return project.committee[commIndex]
}

project.steps.forEach(step => {
    committeeMember = getNextCommitteeMember();
    step.member = committeeMember;
})
